...
axes[1].scatter(x,yOffSmoothed,c='red',picker=True, s=1)
axes[0].scatter(x,y_off,c='red',picker=True,s=1)
plt.title(folderName +" Off Events")


f, axes = plt.subplots(nrows = 2, ncols = 1, sharex=True, sharey = True)
axes[1].scatter(x,yOnSmoothed,c='green',picker=True, s=1)
axes[0].scatter(x,y_on,c='green',picker=True,s=1)
plt.title(folderName +" On Events")


f, axes = plt.subplots(nrows = 2, ncols = 1, sharex=True, sharey = True)
axes[1].scatter(x,yBothSmoothed,c='blue',picker=True, s=1)
axes[0].scatter(x,y_all,c='blue',picker=True,s=1)
